...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between relative">
          ...
          <Link href="/" className="flex items-center gap-3 group relative z-50" onClick={() => setIsOpen(false)}>
            <div className={`p-2 rounded-xl transition-all duration-300 ${
                isScrolled ? 'bg-[#492BFF]' : 'bg-white/10'
            }`}>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className={`hidden md:block px-5 py-2 rounded-full font-bold text-xs transition-all hover:scale-105 shadow-lg ${
                isScrolled 
      ...
      <div 
        className={`fixed inset-0 z-40 bg-[#050505] md:hidden transition-all duration-500 ease-in-out flex flex-col justify-center items-center gap-8 ${
